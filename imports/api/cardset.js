...
Meteor.methods({
	getCSVContent: function (cardset_id, id) {
		if (Roles.userIsInRole(id, 'lecturer')) {
			...
			var newLine = "\r\n"; //Adds a new line
			var firstName = TAPi18n.__('box_export_firstName');
			var lastName = TAPi18n.__('box_export_lastName');
			...
			var content = lastName + colSep + firstName + colSep + eMail + colSep + boxOne + colSep + boxTwo +
