...
export class MailNotifier {
	...
	static prepareErrorReportingsMail(cardsets) {
		if (!Meteor.isServer) {
			...
			const subject = "Es liegen Fehlermeldungen zu Deinen Karten vor.";
			const headerTitle = "Es liegen Fehlermeldungen zu Deinen Karten vor.";
			const bodyTitle = `Es liegen insgesamt ${cardsets.length} Fehler vor.`;
			const bodyText = "Die folgenden unbearbeiteten Fehlermeldungen liegen vor:";
